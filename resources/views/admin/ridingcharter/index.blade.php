                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"><a href="{{ route('admin.add_ridingcharter') }}"><button
                                            type="button" class="btn btn-block bg-gradient-primary">Add Riding Charter
                                        </button></a></h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($ridingcharterDetails->image != null || $ridingcharterDetails->image != '')
                                                        <img src="{{ $ridingcharterDetails->image }}"
                                                ...
                                                <input type="hidden" id="statusval<?php echo $ridingcharterDetails->id; ?>"
                                                    value="<?php echo $ridingcharterDetails->status; ?>">
                                                <input type="hidden" id="riding_charter_id<?php echo $ridingcharterDetails->id; ?>"
                                                    value="<?php echo $ridingcharterDetails->id; ?>">
                                                <td>


                                                    <a
                                                        href="{{ route('admin.view_ridingcharter', ['id' => $ridingcharterDetails->id]) }}">
                                                        <button type="button" class="btn btn-primary"><i
                                                                class="fa fa-eye"></i></button></a>
                                                    <button type="button" class="btn btn-danger" data-toggle="modal"
                                                        data-target="#modal-delete<?php echo $ridingcharterDetails->id; ?>"><i
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer justify-content-between">
                                                            ...
                                                            <a
                                                                href="{{ route('admin.destroy_ridingcharter', [$ridingcharterDetails->id]) }}"><button
