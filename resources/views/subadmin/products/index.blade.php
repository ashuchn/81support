                      ...
                      <div class="card">
                        <div class="card-header">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="p-2">
                                            <h3 class="card-title"><a href="{{ route('subadmin.products.create') }}"><button type="button" class="btn btn-block bg-gradient-primary  btn-primary">Add Product</button></a></h3>
                                        </div>
                                    </div>
                                    <div class="col-8">
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <div class="p-2 ">
                                                <input type="text" class="form-control" name="filter" id="" placeholder="Category, price" required>
                                            </div>
                                            <div class="p-2 ">
                          ...
                          <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                              ...
                              <td class="d-flex">
                                    ...
                                    <form method="POST" action="{{ route('subadmin.products.destroy', ['product' => $item->id]) }}">
                                        @csrf
                                        @method('DELETE')
